...
describe('HTH Cluster', function() {
  var node;
  var daemons = [];
  var execPath = path.resolve(__dirname, process.env.HOME, './.hthcore/data/helpthehomelessd')
  var nodesConf = [
    {
  ...
  it('step 1: will connect to three helpthehomelessd daemons', function(done) {
    ...
    var regtest = hthcore.Networks.get('regtest');
