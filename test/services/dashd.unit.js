...
var DashService = proxyquire('../../lib/services/helpthehomelessd', {
  fs: {
...
describe('HTH Service', function() {
  ...
  describe('@constructor', function() {
    it('will create an instance', function() {
      var helpthehomelessd = new DashService(baseConfig);
      should.exist(helpthehomelessd);
    });
    it('will create an instance without `new`', function() {
      var helpthehomelessd = DashService(baseConfig);
      should.exist(helpthehomelessd);
    });
    it('will init caches', function() {
      var helpthehomelessd = new DashService(baseConfig);
      should.exist(helpthehomelessd.utxosCache);
      should.exist(helpthehomelessd.txidsCache);
      should.exist(helpthehomelessd.balanceCache);
      should.exist(helpthehomelessd.summaryCache);
      should.exist(helpthehomelessd.transactionDetailedCache);
      should.exist(helpthehomelessd.masternodeListCache);

      should.exist(helpthehomelessd.transactionCache);
      should.exist(helpthehomelessd.rawTransactionCache);
      should.exist(helpthehomelessd.blockCache);
      should.exist(helpthehomelessd.rawBlockCache);
      should.exist(helpthehomelessd.blockHeaderCache);
      should.exist(helpthehomelessd.zmqKnownTransactions);
      should.exist(helpthehomelessd.zmqKnownBlocks);
      should.exist(helpthehomelessd.lastTip);
      should.exist(helpthehomelessd.lastTipTimeout);
    });
    it('will init clients', function() {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.nodes.should.deep.equal([]);
      helpthehomelessd.nodesIndex.should.equal(0);
      helpthehomelessd.nodes.push({client: sinon.stub()});
      should.exist(helpthehomelessd.client);
    });
    it('will set subscriptions', function() {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.subscriptions.should.deep.equal({
        address: {},
        rawtransaction: [],
        hashblock: [],
        transactionlock: []
  ...
  describe('#_initDefaults', function() {
    it('will set transaction concurrency', function() {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd._initDefaults({transactionConcurrency: 10});
      helpthehomelessd.transactionConcurrency.should.equal(10);
      helpthehomelessd._initDefaults({});
      helpthehomelessd.transactionConcurrency.should.equal(5);
    });
  });
  ...
  describe('#getAPIMethods', function() {
    it('will return spec', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var methods = helpthehomelessd.getAPIMethods();
  ...
  describe('#getPublishEvents', function() {
    it('will return spec', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var events = helpthehomelessd.getPublishEvents();
      should.exist(events);
      events.length.should.equal(4);
      events[0].name.should.equal('helpthehomelessd/rawtransaction');
      events[0].scope.should.equal(helpthehomelessd);
      events[0].subscribe.should.be.a('function');
      events[0].unsubscribe.should.be.a('function');
      events[1].name.should.equal('helpthehomelessd/transactionlock');
      events[1].scope.should.equal(helpthehomelessd);
      events[1].subscribe.should.be.a('function');
      events[1].unsubscribe.should.be.a('function');
      events[2].name.should.equal('helpthehomelessd/hashblock');
      events[2].scope.should.equal(helpthehomelessd);
      events[2].subscribe.should.be.a('function');
      events[2].unsubscribe.should.be.a('function');
      events[3].name.should.equal('helpthehomelessd/addresstxid');
      events[3].scope.should.equal(helpthehomelessd);
    ...
    it('will call subscribe/unsubscribe with correct args', function() {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.subscribe = sinon.stub();
      helpthehomelessd.unsubscribe = sinon.stub();
      var events = helpthehomelessd.getPublishEvents();

      events[0].subscribe('test');
      helpthehomelessd.subscribe.args[0][0].should.equal('rawtransaction');
      helpthehomelessd.subscribe.args[0][1].should.equal('test');

      events[0].unsubscribe('test');
      helpthehomelessd.unsubscribe.args[0][0].should.equal('rawtransaction');
      helpthehomelessd.unsubscribe.args[0][1].should.equal('test');

      events[1].subscribe('test');
      helpthehomelessd.subscribe.args[1][0].should.equal('transactionlock');
      helpthehomelessd.subscribe.args[1][1].should.equal('test');

      events[1].unsubscribe('test');
      helpthehomelessd.unsubscribe.args[1][0].should.equal('transactionlock');
      helpthehomelessd.unsubscribe.args[1][1].should.equal('test');

      events[2].subscribe('test');
      helpthehomelessd.subscribe.args[2][0].should.equal('hashblock');
      helpthehomelessd.subscribe.args[2][1].should.equal('test');

      events[2].unsubscribe('test');
      helpthehomelessd.unsubscribe.args[2][0].should.equal('hashblock');
      helpthehomelessd.unsubscribe.args[2][1].should.equal('test');
    });
  });
  ...
  describe('#subscribe', function() {
    ...
    it('will push to subscriptions', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var emitter = {};
      helpthehomelessd.subscribe('hashblock', emitter);
      helpthehomelessd.subscriptions.hashblock[0].should.equal(emitter);

      var emitter2 = {};
      helpthehomelessd.subscribe('rawtransaction', emitter2);
      helpthehomelessd.subscriptions.rawtransaction[0].should.equal(emitter2);
    });
  });
  ...
  describe('#unsubscribe', function() {
    ...
    it('will remove item from subscriptions', function() {
      ...
      var emitter4 = {};
      var emitter5 = {};
      helpthehomelessd.subscribe('hashblock', emitter1);
      helpthehomelessd.subscribe('hashblock', emitter2);
      helpthehomelessd.subscribe('hashblock', emitter3);
      helpthehomelessd.subscribe('hashblock', emitter4);
      helpthehomelessd.subscribe('hashblock', emitter5);
      helpthehomelessd.subscriptions.hashblock.length.should.equal(5);

      helpthehomelessd.unsubscribe('hashblock', emitter3);
      helpthehomelessd.subscriptions.hashblock.length.should.equal(4);
      helpthehomelessd.subscriptions.hashblock[0].should.equal(emitter1);
      helpthehomelessd.subscriptions.hashblock[1].should.equal(emitter2);
      helpthehomelessd.subscriptions.hashblock[2].should.equal(emitter4);
      helpthehomelessd.subscriptions.hashblock[3].should.equal(emitter5);
    });
    it('will not remove item an already unsubscribed item', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var emitter1 = {};
      var emitter3 = {};
      helpthehomelessd.subscriptions.hashblock= [emitter1];
      helpthehomelessd.unsubscribe('hashblock', emitter3);
      helpthehomelessd.subscriptions.hashblock.length.should.equal(1);
      helpthehomelessd.subscriptions.hashblock[0].should.equal(emitter1);
    });
  });
  ...
  describe('#subscribeAddress', function() {
    ...
    it('will not an invalid address', function() {
      ...
      helpthehomelessd.subscribeAddress(emitter, ['invalidaddress']);
      should.not.exist(helpthehomelessd.subscriptions.address['invalidaddress']);
    });
    it('will add a valid address', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var emitter = new EventEmitter();
      helpthehomelessd.subscribeAddress(emitter, ['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      should.exist(helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
    });
    it('will handle multiple address subscribers', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      helpthehomelessd.subscribeAddress(emitter1, ['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      helpthehomelessd.subscribeAddress(emitter2, ['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      should.exist(helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'].length.should.equal(2);
    });
    it('will not add the same emitter twice', function() {
      ...
      helpthehomelessd.subscribeAddress(emitter1, ['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      should.exist(helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'].length.should.equal(1);
    });
  });
  ...
  describe('#unsubscribeAddress', function() {
    ...
    it('it will remove a subscription', function() {
      ...
      should.exist(helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'].length.should.equal(2);
      helpthehomelessd.unsubscribeAddress(emitter1, ['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'].length.should.equal(1);
    });
    it('will unsubscribe subscriptions for an emitter', function() {
      ...
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'] = [emitter1, emitter2];
      helpthehomelessd.unsubscribeAddress(emitter1);
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'].length.should.equal(1);
    });
    it('will NOT unsubscribe subscription with missing address', function() {
      ...
      var emitter2 = new EventEmitter();
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'] = [emitter1, emitter2];
      helpthehomelessd.unsubscribeAddress(emitter1, ['XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs']);
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'].length.should.equal(2);
    });
    it('will NOT unsubscribe subscription with missing emitter', function() {
      ...
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'] = [emitter2];
      helpthehomelessd.unsubscribeAddress(emitter1, ['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'].length.should.equal(1);
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'][0].should.equal(emitter2);
    });
    it('will remove empty addresses', function() {
      ...
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'] = [emitter1, emitter2];
      helpthehomelessd.unsubscribeAddress(emitter1, ['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      helpthehomelessd.unsubscribeAddress(emitter2, ['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
      should.not.exist(helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi']);
    });
    it('will unsubscribe emitter for all addresses', function() {
      ...
      var emitter2 = new EventEmitter();
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'] = [emitter1, emitter2];
      helpthehomelessd.subscriptions.address['XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs'] = [emitter1, emitter2];
      sinon.spy(helpthehomelessd, 'unsubscribeAddressAll');
      helpthehomelessd.unsubscribeAddress(emitter1);
      helpthehomelessd.unsubscribeAddressAll.callCount.should.equal(1);
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'].length.should.equal(1);
      helpthehomelessd.subscriptions.address['XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs'].length.should.equal(1);
    });
  });
  ...
  describe('#unsubscribeAddressAll', function() {
    ...
    it('will unsubscribe emitter for all addresses', function() {
      ...
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'] = [emitter1, emitter2];
      helpthehomelessd.subscriptions.address['XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs'] = [emitter1, emitter2];
      helpthehomelessd.subscriptions.address['mgY65WSfEmsyYaYPQaXhmXMeBhwp4EcsQW'] = [emitter2];
      helpthehomelessd.subscriptions.address['7d5169eBcGHF4BYC6DTffTyeCpWbrZnNgz'] = [emitter1];
      helpthehomelessd.unsubscribeAddress(emitter1);
      helpthehomelessd.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'].length.should.equal(1);
      helpthehomelessd.subscriptions.address['XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs'].length.should.equal(1);
      helpthehomelessd.subscriptions.address['mgY65WSfEmsyYaYPQaXhmXMeBhwp4EcsQW'].length.should.equal(1);
      should.not.exist(helpthehomelessd.subscriptions.address['7d5169eBcGHF4BYC6DTffTyeCpWbrZnNgz']);
    });
  });
  ...
  describe('#_getDefaultConfig', function() {
    it('will generate config file from defaults', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var config = helpthehomelessd._getDefaultConfig();
  ...
  describe('#_loadSpawnConfiguration', function() {
    ...
    it('will parse a dash.conf file', function() {
      var TestDash = proxyquire('../../lib/services/helpthehomelessd', {
        fs: {
          readFileSync: readFileSync,
      ...
      var helpthehomelessd = new TestDash(baseConfig);
      helpthehomelessd.options.spawn.datadir = '/tmp/.dash';
      var node = {};
      helpthehomelessd._loadSpawnConfiguration(node);
      should.exist(helpthehomelessd.spawn.config);
      helpthehomelessd.spawn.config.should.deep.equal({
        addressindex: 1,
        checkblocks: 144,
        dbcache: 8192,
    ...
    it('will expand relative datadir to absolute path', function() {
      ...
      var config = {
        node: {
          network: hthcore.Networks.testnet,
          configPath: '/tmp/.hthcore/hthcore-node.json'
        },
        spawn: {
          datadir: './data',
          exec: 'testpath'
      ...
      var helpthehomelessd = new TestDash(config);
      helpthehomelessd.options.spawn.datadir = './data';
      var node = {};
      helpthehomelessd._loadSpawnConfiguration(node);
      helpthehomelessd.options.spawn.datadir.should.equal('/tmp/.hthcore/data');
    });
    it('should throw an exception if txindex isn\'t enabled in the configuration', function() {
      ...
      var helpthehomelessd = new TestDash(baseConfig);
      (function() {
        helpthehomelessd._loadSpawnConfiguration({datadir: './test'});
      }).should.throw(hthcore.errors.InvalidState);
    });
  ...
  describe('#_checkConfigIndexes', function() {
    ...
    it('should warn the user if reindex is set to 1 in the dash.conf file', function() {
      ...
      var node = {};
      helpthehomelessd._checkConfigIndexes(config, node);
  ...
  describe('#_resetCaches', function() {
    it('will reset LRU caches', function() {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        helpthehomelessd.transactionDetailedCache.set(keys[i], {});
        helpthehomelessd.utxosCache.set(keys[i], {});
        helpthehomelessd.txidsCache.set(keys[i], {});
        helpthehomelessd.balanceCache.set(keys[i], {});
        helpthehomelessd.summaryCache.set(keys[i], {});
      }
      helpthehomelessd._resetCaches();
      should.equal(helpthehomelessd.transactionDetailedCache.get(keys[0]), undefined);
      should.equal(helpthehomelessd.utxosCache.get(keys[0]), undefined);
      should.equal(helpthehomelessd.txidsCache.get(keys[0]), undefined);
      should.equal(helpthehomelessd.balanceCache.get(keys[0]), undefined);
      should.equal(helpthehomelessd.summaryCache.get(keys[0]), undefined);
    });
  });
  ...
  describe('#_tryAllClients', function() {
    it('will retry for each node client', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.tryAllInterval = 1;
      helpthehomelessd.nodes.push({
        client: {
      ...
      helpthehomelessd._tryAllClients(function(client, next) {
        client.getInfo(next);
      }, function(err) {
        if (err) {
          return done(err);
        }
        helpthehomelessd.nodes[0].client.getInfo.callCount.should.equal(1);
        helpthehomelessd.nodes[1].client.getInfo.callCount.should.equal(1);
        helpthehomelessd.nodes[2].client.getInfo.callCount.should.equal(1);
        done();
      });
    });
  ...
  describe('#_wrapRPCError', function() {
    it('will convert helpthehomelessd-rpc object into JavaScript error', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var error = helpthehomelessd._wrapRPCError({message: 'Test error', code: -1});
  ...
  describe('#_initChain', function() {
    ...
    it('will set height and genesis buffer', function(done) {
      ...
      helpthehomelessd.getRawBlock = sinon.stub().callsArgWith(1, null, genesisBuffer);
      helpthehomelessd.nodes.push({
        client: {
      ...
      helpthehomelessd._initChain(function() {
        log.info.callCount.should.equal(1);
        helpthehomelessd.getRawBlock.callCount.should.equal(1);
        helpthehomelessd.getRawBlock.args[0][0].should.equal('genesishash');
        helpthehomelessd.height.should.equal(5000);
        helpthehomelessd.genesisBuffer.should.equal(genesisBuffer);
        done();
      });
    });
    it('it will handle error from getBestBlockHash', function(done) {
      ...
      helpthehomelessd._initChain(function(err) {
        err.should.be.instanceOf(Error);
        done();
      });
    });
    ...
    it('it will handle error from getRawBlock', function(done) {
      ...
      helpthehomelessd.getRawBlock = sinon.stub().callsArgWith(1, new Error('test'));
      helpthehomelessd._initChain(function(err) {
        err.should.be.instanceOf(Error);
        done();
      });
  ...
  describe('#_getDefaultConf', function() {
    afterEach(function() {
      hthcore.Networks.disableRegtest();
      baseConfig.node.network = hthcore.Networks.testnet;
    });
    it('will get default rpc port for livenet', function() {
      var config = {
        node: {
          network: hthcore.Networks.livenet
        },
        spawn: {
          datadir: 'testdir',
          exec: 'testpath'
      ...
      var helpthehomelessd = new DashService(config);
      helpthehomelessd._getDefaultConf().rpcport.should.equal(9998);
    });
    it('will get default rpc port for testnet', function() {
      ...
      var helpthehomelessd = new DashService(config);
      helpthehomelessd._getDefaultConf().rpcport.should.equal(19998);
    });
  ...
  describe('#_getNetworkConfigPath', function() {
    ...
    it('will get default config path for livenet', function() {
      ...
      var helpthehomelessd = new DashService(config);
      should.equal(helpthehomelessd._getNetworkConfigPath(), undefined);
    });
    it('will get default rpc port for testnet', function() {
      var config = {
        node: {
      ...
      var helpthehomelessd = new DashService(config);
      helpthehomelessd._getNetworkConfigPath().should.equal('testnet3/dash.conf');
    });
    it('will get default rpc port for regtest', function() {
      hthcore.Networks.enableRegtest();
      var config = {
      ...
      var helpthehomelessd = new DashService(config);
      helpthehomelessd._getNetworkConfigPath().should.equal('regtest/dash.conf');
    });
  });
  ...
  describe('#_getNetworkOption', function() {
    ...
    it('return --testnet for testnet', function() {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.node.network = hthcore.Networks.testnet;
      helpthehomelessd._getNetworkOption().should.equal('--testnet');
    });
    it('return --regtest for testnet', function() {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.node.network = hthcore.Networks.testnet;
      hthcore.Networks.enableRegtest();
      helpthehomelessd._getNetworkOption().should.equal('--regtest');
    });
    it('return undefined for livenet', function() {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.node.network = hthcore.Networks.livenet;
      hthcore.Networks.enableRegtest();
      should.equal(helpthehomelessd._getNetworkOption(), undefined);
    });
  });
  ...
  describe('#_zmqBlockHandler', function() {
    it('will emit block', function(done) {
      ...
      helpthehomelessd._rapidProtectedUpdateTip = sinon.stub();
      helpthehomelessd.on('block', function(block) {
        block.should.equal(message);
        done();
      });
      helpthehomelessd._zmqBlockHandler(node, message);
    });
    ...
    it('will call function to update tip', function() {
      ...
      helpthehomelessd._rapidProtectedUpdateTip = sinon.stub();
      helpthehomelessd._zmqBlockHandler(node, message);
      helpthehomelessd._rapidProtectedUpdateTip.callCount.should.equal(1);
      helpthehomelessd._rapidProtectedUpdateTip.args[0][0].should.equal(node);
      helpthehomelessd._rapidProtectedUpdateTip.args[0][1].should.equal(message);
    });
    it('will emit to subscribers', function(done) {
      ...
      helpthehomelessd._rapidProtectedUpdateTip = sinon.stub();
      var emitter = new EventEmitter();
      helpthehomelessd.subscriptions.hashblock.push(emitter);
      emitter.on('helpthehomelessd/hashblock', function(blockHash) {
  ...
  describe('#_rapidProtectedUpdateTip', function() {
    it('will limit tip updates with rapid calls', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      var callCount = 0;
      helpthehomelessd._updateTip = function() {
        callCount++;
      ...
      var count = 0;
      function repeat() {
        helpthehomelessd._rapidProtectedUpdateTip(node, message);
        count++;
        if (count < 50) {
          repeat();
        }
  ...
  describe('#_updateTip', function() {
    ...
    it('log and emit rpc error from get block', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.syncPercentage = sinon.stub();
      ...
      helpthehomelessd._updateTip(node, message);
    });
    it('emit synced if percentage is 100', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.syncPercentage = sinon.stub().callsArgWith(0, null, 100);
      helpthehomelessd.on('synced', function() {
        done();
      });
      var node = {
        client: {
    ...
    it('NOT emit synced if percentage is less than 100', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.syncPercentage = sinon.stub().callsArgWith(0, null, 99);
      helpthehomelessd.on('synced', function() {
    ...
    it('log and emit error from syncPercentage', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.syncPercentage = sinon.stub().callsArgWith(0, new Error('test'));
      helpthehomelessd.on('error', function(err) {
        log.error.callCount.should.equal(1);
        err.message.should.equal('test');
        done();
    ...
    it('reset caches and set height', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.syncPercentage = sinon.stub();
      helpthehomelessd._resetCaches = sinon.stub();
      helpthehomelessd.on('tip', function(height) {
        helpthehomelessd._resetCaches.callCount.should.equal(1);
        height.should.equal(10);
        helpthehomelessd.height.should.equal(10);
        done();
      });
      var node = {
        client: {
    ...
    it('will NOT update twice for the same hash', function(done) {
      ...
      helpthehomelessd.syncPercentage = sinon.stub();
      helpthehomelessd._resetCaches = sinon.stub();
      helpthehomelessd.on('tip', function() {
        done();
      });
      var node = {
        client: {
    ...
    it('will not call syncPercentage if node is stopping', function(done) {
      ...
      helpthehomelessd.on('tip', function() {
        helpthehomelessd.syncPercentage.callCount.should.equal(0);
        done();
      });
      helpthehomelessd._updateTip(node, message);
    });
  ...
  describe('#_getAddressesFromTransaction', function() {
    it('will get results using hthcore.Transaction', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var wif = 'XGLgPK8gbmzU7jcbw34Pj55AXV7SmG6carKuiwtu4WtvTjyTbpwX';
      var privkey = hthcore.PrivateKey.fromWIF(wif);
      var inputAddress = privkey.toAddress(hthcore.Networks.testnet);
      var outputAddress = hthcore.Address('8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi');
      var tx = hthcore.Transaction();
      tx.from({
        txid: '4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b',
        outputIndex: 0,
        script: hthcore.Script(inputAddress),
        address: inputAddress.toString(),
        satoshis: 5000000000
      });
      tx.to(outputAddress, 5000000000);
      tx.sign(privkey);
      var addresses = helpthehomelessd._getAddressesFromTransaction(tx);
    ...
    it('will handle non-standard script types', function() {
      ...
      tx.addOutput(hthcore.Transaction.Output({
        script: hthcore.Script('OP_TRUE'),
        satoshis: 5000000000
      }));
      var addresses = helpthehomelessd._getAddressesFromTransaction(tx);
    ...
    it('will return unique values', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var tx = hthcore.Transaction();
      var address = hthcore.Address('8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi');
      tx.addOutput(hthcore.Transaction.Output({
        script: hthcore.Script(address),
        satoshis: 5000000000
      }));
      tx.addOutput(hthcore.Transaction.Output({
        script: hthcore.Script(address),
  ...
  describe('#_notifyAddressTxidSubscribers', function() {
    it('will emit event if matching addresses', function(done) {
      ...
      helpthehomelessd._getAddressesFromTransaction = sinon.stub().returns([address]);
      var emitter = new EventEmitter();
      helpthehomelessd.subscriptions.address[address] = [emitter];
      var txid = '46f24e0c274fc07708b781963576c4c5d5625d926dbb0a17fa865dcd9fe58ea0';
      var transaction = {};
      emitter.on('helpthehomelessd/addresstxid', function(data) {
        data.address.should.equal(address);
        data.txid.should.equal(txid);
        done();
      });
      sinon.spy(emitter, 'emit');
      helpthehomelessd._notifyAddressTxidSubscribers(txid, transaction);
  ...
  describe('#_zmqTransactionHandler', function() {
    it('will emit to subscribers', function(done) {
      ...
      var emitter = new EventEmitter();
      helpthehomelessd.subscriptions.rawtransaction.push(emitter);
      emitter.on('helpthehomelessd/rawtransaction', function(hex) {
        hex.should.be.a('string');
        hex.should.equal(expectedBuffer.toString('hex'));
        done();
      });
      var node = {};
      helpthehomelessd._zmqTransactionHandler(node, expectedBuffer);
    });
    it('will NOT emit to subscribers more than once for the same tx', function(done) {
      ...
      var emitter = new EventEmitter();
      helpthehomelessd.subscriptions.rawtransaction.push(emitter);
      emitter.on('helpthehomelessd/rawtransaction', function() {
        done();
      });
      var node = {};
      helpthehomelessd._zmqTransactionHandler(node, expectedBuffer);
    ...
    it('will NOT emit "tx" event more than once for the same tx', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      var expectedBuffer = new Buffer(txhex, 'hex');
      helpthehomelessd.on('tx', function() {
        done();
      });
      var node = {};
      helpthehomelessd._zmqTransactionHandler(node, expectedBuffer);
  ...
  describe('#_zmqTransactionLockHandler', function() {
    it('will emit to subscribers', function(done) {
      ...
      var expectedBuffer = new Buffer(txhex, 'hex');
      var emitter = new EventEmitter();
      helpthehomelessd.subscriptions.transactionlock.push(emitter);
      emitter.on('helpthehomelessd/transactionlock', function(hex) {
        hex.should.be.a('string');
        hex.should.equal(expectedBuffer.toString('hex'));
        done();
      });
      var node = {};
      helpthehomelessd._zmqTransactionLockHandler(node, expectedBuffer);
    });
    it('will NOT emit to subscribers more than once for the same tx', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      var expectedBuffer = new Buffer(txhex, 'hex');
      var emitter = new EventEmitter();
      helpthehomelessd.subscriptions.transactionlock.push(emitter);
      emitter.on('helpthehomelessd/transactionlock', function() {
        done();
      });
      var node = {};
      helpthehomelessd._zmqTransactionLockHandler(node, expectedBuffer);
    ...
    it('will emit "tx" event', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      var expectedBuffer = new Buffer(txhex, 'hex');
      helpthehomelessd.on('txlock', function(buffer) {
        buffer.should.be.instanceof(Buffer);
        buffer.toString('hex').should.equal(expectedBuffer.toString('hex'));
        done();
      });
    ...
    it('will NOT emit "tx" event more than once for the same tx', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      var expectedBuffer = new Buffer(txhex, 'hex');
      helpthehomelessd.on('txlock', function() {
        done();
      });
      var node = {};
      helpthehomelessd._zmqTransactionLockHandler(node, expectedBuffer);
  ...
  describe('#_checkSyncedAndSubscribeZmqEvents', function() {
    ...
    it('log errors, update tip and subscribe to zmq events', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd._updateTip = sinon.stub();
      helpthehomelessd._subscribeZmqEvents = sinon.stub();
      var blockEvents = 0;
      helpthehomelessd.on('block', function() {
        blockEvents++;
      });
      var getBestBlockHash = sinon.stub().callsArgWith(0, null, {
      ...
      helpthehomelessd._checkSyncedAndSubscribeZmqEvents(node);
      setTimeout(function() {
        log.error.callCount.should.equal(2);
        blockEvents.should.equal(11);
        helpthehomelessd._updateTip.callCount.should.equal(11);
        helpthehomelessd._subscribeZmqEvents.callCount.should.equal(1);
        done();
      }, 200);
    });
  ...
  describe('#_subscribeZmqEvents', function() {
    it('will call subscribe on zmq socket', function() {
      ...
      helpthehomelessd._subscribeZmqEvents(node);
    ...
    it('will call relevant handler for rawtx topics', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd._zmqTransactionHandler = sinon.stub();
      var node = {
      ...
      node.zmqSubSocket.on('message', function() {
        helpthehomelessd._zmqTransactionHandler.callCount.should.equal(1);
        done();
      });
    ...
    it('will call relevant handler for hashblock topics', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd._zmqBlockHandler = sinon.stub();
      var node = {
        zmqSubSocket: new EventEmitter()
      };
      node.zmqSubSocket.subscribe = sinon.stub();
      helpthehomelessd._subscribeZmqEvents(node);
      node.zmqSubSocket.on('message', function() {
        helpthehomelessd._zmqBlockHandler.callCount.should.equal(1);
        done();
      });
    ...
    it('will ignore unknown topic types', function(done) {
      ...
      helpthehomelessd._subscribeZmqEvents(node);
      node.zmqSubSocket.on('message', function() {
        helpthehomelessd._zmqBlockHandler.callCount.should.equal(0);
        helpthehomelessd._zmqTransactionHandler.callCount.should.equal(0);
        done();
      });
  ...
  describe('#_initZmqSubSocket', function() {
    it('will setup zmq socket', function() {
      ...
      var helpthehomelessd = new DashService(baseConfig);
      var node = {};
      helpthehomelessd._initZmqSubSocket(node, 'url');
  ...
  describe('#_checkReindex', function() {
    ...
    it('give error from client getblockchaininfo', function(done) {
      ...
      helpthehomelessd._checkReindex(node, function(err) {
        should.exist(err);
    ...
    it('will wait until sync is 100 percent', function(done) {
      ...
      helpthehomelessd._checkReindex(node, function() {
  ...
  describe('#_loadTipFromNode', function() {
    ...
    it('will give rpc from client getbestblockhash', function(done) {
      ...
      helpthehomelessd._loadTipFromNode(node, function(err) {
        err.should.be.instanceof(Error);
    ...
    it('will set height and emit tip', function(done) {
      ...
      helpthehomelessd.on('tip', function(height) {
        ...
        helpthehomelessd.height.should.equal(100);
        done();
      });
      helpthehomelessd._loadTipFromNode(node, function(err) {
        if (err) {
  ...
  describe('#_stopSpawnedProcess', function() {
    ...
    it('it will kill process and resume', function(done) {
      ...
      var TestDashService = proxyquire('../../lib/services/helpthehomelessd', {
        fs: {
          readFile: readFile
        }
      });
      var helpthehomelessd = new TestDashService(baseConfig);
      helpthehomelessd.spawnStopTime = 1;
      helpthehomelessd._process = {};
      helpthehomelessd._process.kill = sinon.stub();
      helpthehomelessd._stopSpawnedDash(function(err) {
        if (err) {
          return done(err);
        }
        helpthehomelessd._process.kill.callCount.should.equal(1);
        log.warn.callCount.should.equal(1);
        done();
      });
    });
    it('it will attempt to kill process and resume', function(done) {
      ...
      error2.code = 'ESRCH';
      helpthehomelessd._process.kill = sinon.stub().throws(error2);
      helpthehomelessd._stopSpawnedDash(function(err) {
        if (err) {
          return done(err);
        }
  ...
  describe('#_spawnChildProcess', function() {
    ...
    it('will give error from spawn config', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd._loadSpawnConfiguration = sinon.stub();
      helpthehomelessd._loadSpawnConfiguration = sinon.stub().throws(new Error('test'));
      helpthehomelessd._spawnChildProcess(function(err) {
        err.should.be.instanceof(Error);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will give error from stopSpawnedDash', function() {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd._loadSpawnConfiguration = sinon.stub();
      helpthehomelessd._stopSpawnedDash = sinon.stub().callsArgWith(0, new Error('test'));
      helpthehomelessd._spawnChildProcess(function(err) {
        err.should.be.instanceOf(Error);
        err.message.should.equal('test');
      });
    ...
    it('will exit spawn if shutdown', function() {
      ...
      var helpthehomelessd = new TestDashService(config);
      helpthehomelessd.spawn = {};
      helpthehomelessd._loadSpawnConfiguration = sinon.stub();
      helpthehomelessd._stopSpawnedDash = sinon.stub().callsArgWith(0, null);
      helpthehomelessd.node.stopping = true;
      helpthehomelessd._spawnChildProcess(function(err) {
        err.should.be.instanceOf(Error);
    ...
    it('will include network with spawn command and init zmq/rpc on node', function(done) {
      ...
      helpthehomelessd._loadSpawnConfiguration = sinon.stub();
      helpthehomelessd.spawn = {};
      helpthehomelessd.spawn.exec = 'testexec';
      helpthehomelessd.spawn.configPath = 'testdir/dash.conf';
      helpthehomelessd.spawn.datadir = 'testdir';
      helpthehomelessd.spawn.config = {};
      helpthehomelessd.spawn.config.rpcport = 20001;
      helpthehomelessd.spawn.config.rpcuser = 'dash';
      helpthehomelessd.spawn.config.rpcpassword = 'password';
      helpthehomelessd.spawn.config.zmqpubrawtx = 'tcp://127.0.0.1:30001';
      helpthehomelessd.spawn.config.zmqpubrawtxlock = 'tcp://127.0.0.1:30001';

      helpthehomelessd._loadTipFromNode = sinon.stub().callsArgWith(1, null);
      helpthehomelessd._initZmqSubSocket = sinon.stub();
      helpthehomelessd._checkSyncedAndSubscribeZmqEvents = sinon.stub();
      helpthehomelessd._checkReindex = sinon.stub().callsArgWith(1, null);
      helpthehomelessd._spawnChildProcess(function(err, node) {
        ...
        helpthehomelessd._loadTipFromNode.callCount.should.equal(1);
        helpthehomelessd._initZmqSubSocket.callCount.should.equal(1);
        should.exist(helpthehomelessd._initZmqSubSocket.args[0][0].client);
        helpthehomelessd._initZmqSubSocket.args[0][1].should.equal('tcp://127.0.0.1:30001');
        helpthehomelessd._checkSyncedAndSubscribeZmqEvents.callCount.should.equal(1);
        should.exist(helpthehomelessd._checkSyncedAndSubscribeZmqEvents.args[0][0].client);
        should.exist(node);
        should.exist(node.client);
        done();
      });
    });
    it('will respawn helpthehomelessd spawned process', function(done) {
      var process = new EventEmitter();
      var spawn = sinon.stub().returns(process);
      var TestDashService = proxyquire('../../lib/services/helpthehomelessd', {
        fs: {
      ...
      helpthehomelessd._loadSpawnConfiguration = sinon.stub();
      helpthehomelessd.spawn = {};
      helpthehomelessd.spawn.exec = 'helpthehomelessd';
      helpthehomelessd.spawn.datadir = '/tmp/dash';
      helpthehomelessd.spawn.configPath = '/tmp/dash/dash.conf';
      helpthehomelessd.spawn.config = {};
      helpthehomelessd.spawnRestartTime = 1;
      helpthehomelessd._loadTipFromNode = sinon.stub().callsArg(1);
      helpthehomelessd._initZmqSubSocket = sinon.stub();
      helpthehomelessd._checkReindex = sinon.stub().callsArg(1);
      helpthehomelessd._checkSyncedAndSubscribeZmqEvents = sinon.stub();
      helpthehomelessd._stopSpawnedDash = sinon.stub().callsArg(0);
      sinon.spy(helpthehomelessd, '_spawnChildProcess');
      helpthehomelessd._spawnChildProcess(function(err) {
        if (err) {
          return done(err);
        }
        process.once('exit', function() {
          setTimeout(function() {
            helpthehomelessd._spawnChildProcess.callCount.should.equal(2);
            done();
          }, 5);
        });
        process.emit('exit', 1);
    ...
    it('will emit error during respawn', function(done) {
      ...
      helpthehomelessd._spawnChildProcess(function(err) {
        ...
        helpthehomelessd._spawnChildProcess = sinon.stub().callsArgWith(0, new Error('test'));
        helpthehomelessd.on('error', function(err) {
          err.should.be.instanceOf(Error);
          err.message.should.equal('test');
          done();
    ...
    it('will NOT respawn helpthehomelessd spawned process if shutting down', function(done) {
      var process = new EventEmitter();
      var spawn = sinon.stub().returns(process);
      var TestDashService = proxyquire('../../lib/services/helpthehomelessd', {
        fs: {
      ...
      helpthehomelessd._spawnChildProcess(function(err) {
        ...
        process.once('exit', function() {
          setTimeout(function() {
            helpthehomelessd._spawnChildProcess.callCount.should.equal(1);
            done();
          }, 5);
        });
        process.emit('exit', 1);
    ...
    it('will give error after 60 retries', function(done) {
      ...
      var helpthehomelessd = new TestDashService(baseConfig);
      helpthehomelessd.startRetryInterval = 1;
      helpthehomelessd._loadSpawnConfiguration = sinon.stub();
      helpthehomelessd.spawn = {};
      helpthehomelessd.spawn.exec = 'testexec';
      helpthehomelessd.spawn.configPath = 'testdir/dash.conf';
      ...
      helpthehomelessd.spawn.config.zmqpubrawtx = 'tcp://127.0.0.1:30001';
      helpthehomelessd.spawn.config.zmqpubrawtxlock = 'tcp://127.0.0.1:30001';
      helpthehomelessd._loadTipFromNode = sinon.stub().callsArgWith(1, new Error('test'));
      helpthehomelessd._spawnChildProcess(function(err) {
        helpthehomelessd._loadTipFromNode.callCount.should.equal(60);
        err.should.be.instanceof(Error);
        done();
      });
    });
    it('will give error from check reindex', function(done) {
      ...
      helpthehomelessd._initZmqSubSocket = sinon.stub();
      helpthehomelessd._checkSyncedAndSubscribeZmqEvents = sinon.stub();
      helpthehomelessd._checkReindex = sinon.stub().callsArgWith(1, new Error('test'));
  ...
  describe('#_connectProcess', function() {
    it('will give error if connecting while shutting down', function(done) {
      ...
      var helpthehomelessd = new DashService(config);
      helpthehomelessd.node.stopping = true;
      helpthehomelessd.startRetryInterval = 100;
      helpthehomelessd._loadTipFromNode = sinon.stub();
      helpthehomelessd._connectProcess({}, function(err) {
        err.should.be.instanceof(Error);
        err.message.should.match(/Stopping while trying to connect/);
        helpthehomelessd._loadTipFromNode.callCount.should.equal(0);
        done();
      });
    });
    it('will give error from loadTipFromNode after 60 retries', function(done) {
      ...
      helpthehomelessd.startRetryInterval = 1;
      var config = {};
      helpthehomelessd._connectProcess(config, function(err) {
        err.should.be.instanceof(Error);
        helpthehomelessd._loadTipFromNode.callCount.should.equal(60);
        done();
      });
    ...
    it('will init zmq/rpc on node', function(done) {
      ...
      helpthehomelessd._loadTipFromNode = sinon.stub().callsArgWith(1, null);
      var config = {};
      helpthehomelessd._connectProcess(config, function(err, node) {
        should.not.exist(err);
        helpthehomelessd._loadTipFromNode.callCount.should.equal(1);
        helpthehomelessd._initZmqSubSocket.callCount.should.equal(1);
        helpthehomelessd._loadTipFromNode.callCount.should.equal(1);
  ...
  describe('#start', function() {
    ...
    it('will give error if "spawn" and "connect" are both not configured', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.options = {};
      helpthehomelessd.start(function(err) {
        err.should.be.instanceof(Error);
        err.message.should.match(/HTH configuration options/);
      });
      done();
    });
    ...
    it('will give error from connectProcess', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd._connectProcess = sinon.stub().callsArgWith(1, new Error('test'));
      helpthehomelessd.options = {
        connect: [
          {}
        ]
      ...
      helpthehomelessd.start(function(err) {
        helpthehomelessd._connectProcess.callCount.should.equal(1);
        err.should.be.instanceof(Error);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will push node from spawnChildProcess', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      var node = {};
      helpthehomelessd._initChain = sinon.stub().callsArg(0);
      helpthehomelessd._spawnChildProcess = sinon.stub().callsArgWith(0, null, node);
      helpthehomelessd.options = {
        spawn: {}
      };
      helpthehomelessd.start(function(err) {
        should.not.exist(err);
        helpthehomelessd.nodes.length.should.equal(1);
        done();
      });
    });
    it('will push node from connectProcess', function(done) {
      ...
      helpthehomelessd._initChain = sinon.stub().callsArg(0);
      var nodes = [{}];
      helpthehomelessd._connectProcess = sinon.stub().callsArgWith(1, null, nodes);
      helpthehomelessd.options = {
        connect: [
          {}
        ]
  ...
  describe('#isSynced', function() {
    it('will give error from syncPercentage', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.syncPercentage = sinon.stub().callsArgWith(0, new Error('test'));
      helpthehomelessd.isSynced(function(err) {
        should.exist(err);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will give "true" if percentage is 100.00', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.syncPercentage = sinon.stub().callsArgWith(0, null, 100.00);
      helpthehomelessd.isSynced(function(err, synced) {
        if (err) {
          return done(err);
        }
    ...
    it('will give "true" if percentage is 99.98', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.syncPercentage = sinon.stub().callsArgWith(0, null, 99.98);
      helpthehomelessd.isSynced(function(err, synced) {
        if (err) {
          return done(err);
        }
    ...
    it('will give "false" if percentage is 99.49', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.syncPercentage = sinon.stub().callsArgWith(0, null, 99.49);
      helpthehomelessd.isSynced(function(err, synced) {
        if (err) {
          return done(err);
        }
    ...
    it('will give "false" if percentage is 1', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.syncPercentage = sinon.stub().callsArgWith(0, null, 1);
      helpthehomelessd.isSynced(function(err, synced) {
        if (err) {
          return done(err);
        }
  ...
  describe('#syncPercentage', function() {
    it('will give rpc error', function(done) {
      ...
      helpthehomelessd.syncPercentage(function(err) {
        should.exist(err);
    ...
    it('will call client getInfo and give result', function(done) {
      ...
      helpthehomelessd.syncPercentage(function(err, percentage) {
        if (err) {
          return done(err);
        }
  ...
  describe('#_normalizeAddressArg', function() {
    it('will turn single address into array', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var args = helpthehomelessd._normalizeAddressArg('address');
      args.should.deep.equal(['address']);
    });
    it('will keep an array as an array', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var args = helpthehomelessd._normalizeAddressArg(['address', 'address']);
  ...
  describe('#getAddressBalance', function() {
    it('will give rpc error', function(done) {
      ...
      var address = 'XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs';
      var options = {};
      helpthehomelessd.getAddressBalance(address, options, function(err) {
        err.should.be.instanceof(Error);
        done();
      });
    });
    it('will give balance', function(done) {
      ...
      var address = 'XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs';
      var options = {};
      helpthehomelessd.getAddressBalance(address, options, function(err, data) {
        if (err) {
          return done(err);
        }
        data.balance.should.equal(10000);
        data.received.should.equal(100000);
        helpthehomelessd.getAddressBalance(address, options, function(err, data2) {
          if (err) {
            return done(err);
          }
  ...
  describe('#getAddressUnspentOutputs', function() {
    it('will give rpc error', function(done) {
      ...
      var address = 'XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs';
      helpthehomelessd.getAddressUnspentOutputs(address, options, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will give results from client getaddressutxos', function(done) {
      ...
      var address = 'XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs';
      helpthehomelessd.getAddressUnspentOutputs(address, options, function(err, utxos) {
        if (err) {
          return done(err);
        }
  ...
  describe('#_getBalanceFromMempool', function() {
    it('will sum satoshis', function() {
      ...
      var sum = helpthehomelessd._getBalanceFromMempool(deltas);
  ...
  describe('#_getTxidsFromMempool', function() {
    it('will filter to txids', function() {
      ...
      var txids = helpthehomelessd._getTxidsFromMempool(deltas);
  ...
  describe('#_getHeightRangeQuery', function() {
    it('will detect range query', function() {
      ...
      var rangeQuery = helpthehomelessd._getHeightRangeQuery(options);
    ...
    it('will get range properties', function() {
      ...
      var clone = {};
      helpthehomelessd._getHeightRangeQuery(options, clone);
    ...
    it('will throw error with invalid range', function() {
      ...
      (function() {
        helpthehomelessd._getHeightRangeQuery(options);
  ...
  describe('#getAddressTxids', function() {
    it('will give error from _getHeightRangeQuery', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd._getHeightRangeQuery = sinon.stub().throws(new Error('test'));
      helpthehomelessd.getAddressTxids('address', {}, function(err) {
        err.should.be.instanceOf(Error);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will give rpc error from mempool query', function() {
      ...
      var options = {};
      var address = 'XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs';
      helpthehomelessd.getAddressTxids(address, options, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
      });
    });
    ...
    it('will get txid results', function(done) {
      ...
      var address = 'XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs';
      helpthehomelessd.getAddressTxids(address, options, function(err, txids) {
        if (err) {
          return done(err);
        }
    ...
    it('will get txid results from cache and live mempool', function(done) {
      ...
      var address = 'XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs';
      helpthehomelessd.getAddressTxids(address, {queryMempool: false}, function(err, txids) {
        if (err) {
          return done(err);
        }
        getAddressTxids.callCount.should.equal(1);
        ...
        helpthehomelessd.getAddressTxids(address, {queryMempool: true}, function(err, txids) {
          if (err) {
            return done(err);
          }
          getAddressTxids.callCount.should.equal(1);
  ...
  describe('#_getConfirmationDetail', function() {
    ...
    it('should get 0 confirmation', function() {
      ...
      tx.height = -1;
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.height = 10;
      var confirmations = helpthehomelessd._getConfirmationsDetail(tx);
  ...
  describe('#_getAddressDetailsForInput', function() {
    it('will return if missing an address', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var result = {};
      helpthehomelessd._getAddressDetailsForInput({}, 0, result, []);
    ...
    it('will only add address if it matches', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var result = {};
      helpthehomelessd._getAddressDetailsForInput({
        address: 'address1'
      }, 0, result, ['address2']);
      should.not.exist(result.addresses);
      should.not.exist(result.satoshis);
  ...
  describe('#_getAddressDetailsForOutput', function() {
    it('will return if missing an address', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var result = {};
      helpthehomelessd._getAddressDetailsForOutput({}, 0, result, []);
      should.not.exist(result.addresses);
      should.not.exist(result.satoshis);
    });
    it('will only add address if it matches', function() {
      var helpthehomelessd = new DashService(baseConfig);
      var result = {};
      helpthehomelessd._getAddressDetailsForOutput({
        address: 'address1'
      }, 0, result, ['address2']);
      should.not.exist(result.addresses);
      should.not.exist(result.satoshis);
  ...
  describe('#_getAddressDetailsForTransaction', function() {
    it('will calculate details for the transaction', function(done) {
      ...
      var details = helpthehomelessd._getAddressDetailsForTransaction(tx, addresses);
  ...
  describe('#_getAddressDetailedTransaction', function() {
    it('will get detailed transaction info', function(done) {
      ...
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.getDetailedTransaction = sinon.stub().callsArgWith(1, null, tx);
      helpthehomelessd.height = 300;
      var addresses = {};
      helpthehomelessd._getAddressDetailsForTransaction = sinon.stub().returns({
        addresses: addresses,
        satoshis: 1000,
      });
      helpthehomelessd._getAddressDetailedTransaction(txid, {}, function(err, details) {
        if (err) {
          return done(err);
        }
    ...
    it('give error from getDetailedTransaction', function(done) {
      var txid = '46f24e0c274fc07708b781963576c4c5d5625d926dbb0a17fa865dcd9fe58ea0';
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.getDetailedTransaction = sinon.stub().callsArgWith(1, new Error('test'));
      helpthehomelessd._getAddressDetailedTransaction(txid, {}, function(err) {
        err.should.be.instanceof(Error);
        done();
      });
    });
  ...
  describe('#_getAddressStrings', function() {
    it('will get address strings from hthcore addresses', function() {
      var addresses = [
        hthcore.Address('XjxDQFjTNEP9dcrJhBLvy5i1Dobz4x1LJN'),
        hthcore.Address('7d5169eBcGHF4BYC6DTffTyeCpWbrZnNgz'),
      ];
      var helpthehomelessd = new DashService(baseConfig);
      var strings = helpthehomelessd._getAddressStrings(addresses);
    ...
    it('will give error with unknown', function() {
      ...
      var helpthehomelessd = new DashService(baseConfig);
      (function() {
        helpthehomelessd._getAddressStrings(addresses);
  ...
  describe('#getAddressHistory', function() {
    ...
    it('will give error with "from" and "to" range that exceeds max size', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.getAddressHistory(address, {from: 0, to: 51}, function(err) {
        should.exist(err);
    ...
    it('will give error with "from" and "to" order is reversed', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.getAddressTxids = sinon.stub().callsArgWith(2, null, []);
      helpthehomelessd.getAddressHistory(address, {from: 51, to: 0}, function(err) {
        should.exist(err);
        err.message.match(/^\"from/);
        done();
      });
    ...
    it('will give error from _getAddressDetailedTransaction', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.getAddressTxids = sinon.stub().callsArgWith(2, null, ['txid']);
      helpthehomelessd._getAddressDetailedTransaction = sinon.stub().callsArgWith(2, new Error('test'));
      helpthehomelessd.getAddressHistory(address, {}, function(err) {
        should.exist(err);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will give an error if length of addresses is too long', function(done) {
      ...
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.maxAddressesQuery = 100;
      helpthehomelessd.getAddressHistory(addresses, {}, function(err) {
        should.exist(err);
    ...
    it('give error from getAddressTxids', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.getAddressTxids = sinon.stub().callsArgWith(2, new Error('test'));
      helpthehomelessd.getAddressHistory('address', {}, function(err) {
        should.exist(err);
        err.should.be.instanceof(Error);
        err.message.should.equal('test');
    ...
    it('will paginate', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd._getAddressDetailedTransaction = function(txid, options, callback) {
        callback(null, txid);
      };
      var txids = ['one', 'two', 'three', 'four'];
      helpthehomelessd.getAddressTxids = sinon.stub().callsArgWith(2, null, txids);
      helpthehomelessd.getAddressHistory('address', {from: 1, to: 3}, function(err, data) {
        if (err) {
          return done(err);
        }
  ...
  describe('#getAddressSummary', function() {
    ...
    it('will handle error from getAddressTxids', function(done) {
      ...
      helpthehomelessd.getAddressTxids = sinon.stub().callsArgWith(2, new Error('test'));
      helpthehomelessd.getAddressBalance = sinon.stub().callsArgWith(2, null, {});
      var address = '';
      var options = {};
      helpthehomelessd.getAddressSummary(address, options, function(err) {
        should.exist(err);
        err.should.be.instanceof(Error);
        err.message.should.equal('test');
        done();
    ...
    it('will handle error from getAddressBalance', function(done) {
      ...
      helpthehomelessd.getAddressTxids = sinon.stub().callsArgWith(2, null, {});
      helpthehomelessd.getAddressBalance = sinon.stub().callsArgWith(2, new Error('test'), {});
      var address = '';
      var options = {};
      helpthehomelessd.getAddressSummary(address, options, function(err) {
        should.exist(err);
    ...
    it('should set all properties', function(done) {
      ...
      sinon.spy(helpthehomelessd, '_paginate');
      helpthehomelessd.getAddressTxids = sinon.stub().callsArgWith(2, null, [txid1, txid2, txid3]);
      helpthehomelessd.getAddressBalance = sinon.stub().callsArgWith(2, null, {
        received: 30 * 1e8,
        balance: 20 * 1e8
      });
      ...
      var options = {};
      helpthehomelessd.getAddressSummary(address, options, function(err, summary) {
        helpthehomelessd._paginate.callCount.should.equal(1);
        helpthehomelessd._paginate.args[0][1].should.equal(0);
        helpthehomelessd._paginate.args[0][2].should.equal(1000);
    ...
    it('will get from cache with noTxList', function(done) {
      ...
      helpthehomelessd.getAddressSummary(address, options, function(err, summary) {
        ...
        helpthehomelessd.getAddressTxids.callCount.should.equal(1);
        helpthehomelessd.getAddressBalance.callCount.should.equal(1);
        helpthehomelessd.getAddressSummary(address, options, function(err, summary) {
          checkSummary(summary);
          helpthehomelessd.getAddressTxids.callCount.should.equal(1);
          helpthehomelessd.getAddressBalance.callCount.should.equal(1);
    ...
    it('will skip querying the mempool with queryMempool set to false', function(done) {
      ...
      helpthehomelessd.getAddressSummary(address, options, function() {
        getAddressMempool.callCount.should.equal(0);
        done();
      });
    });
    it('will give error from _paginate', function(done) {
      ...
      helpthehomelessd._paginate = sinon.stub().throws(new Error('test'));
      var address = '7oK6xjGeVK5YCT5dpqzNXGUag1bQadPAyT';
      var options = {
        queryMempool: false
      };
  ...
  describe('#getRawBlock', function() {
    ...
    it('will give rcp error from client getblockhash', function(done) {
      ...
      helpthehomelessd.getRawBlock(10, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will give rcp error from client getblock', function(done) {
      ...
      helpthehomelessd.getRawBlock(blockhash, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will try all nodes for getblock', function(done) {
      ...
      helpthehomelessd.nodesIndex = 2;
      helpthehomelessd.getRawBlock(blockhash, function(err, buffer) {
        if (err) {
          return done(err);
        }
        buffer.should.be.instanceof(Buffer);
    ...
    it('will get block by height', function(done) {
      ...
      helpthehomelessd.getRawBlock(0, function(err, buffer) {
        if (err) {
          return done(err);
        }
        buffer.should.be.instanceof(Buffer);
  ...
  describe('#getBlock', function() {
    ...
    it('will give an rpc error from client getblock', function(done) {
      ...
      helpthehomelessd.getBlock(0, function(err) {
        err.should.be.instanceof(Error);
        done();
      });
    });
    ...
    it('will getblock as hthcore object from height', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      var getBlock = sinon.stub().callsArgWith(2, null, {
        result: blockhex
      });
      ...
      helpthehomelessd.getBlock(0, function(err, block) {
        should.not.exist(err);
        ...
        block.should.be.instanceof(hthcore.Block);
        done();
      });
    });
    it('will getblock as hthcore object', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      var getBlock = sinon.stub().callsArgWith(2, null, {
        result: blockhex
      });
      ...
      helpthehomelessd.getBlock('00000000050a6d07f583beba2d803296eb1e9d4980c4a20f206c584e89a4f02b', function(err, block) {
        should.not.exist(err);
    ...
    it('will get block from cache', function(done) {
      ...
      helpthehomelessd.getBlock(hash, function(err, block) {
        should.not.exist(err);
        getBlockHash.callCount.should.equal(0);
        getBlock.callCount.should.equal(1);
        block.should.be.instanceof(hthcore.Block);
  ...
  describe('#getBlockHashesByTimestamp', function() {
    it('should give an rpc error', function(done) {
      ...
      helpthehomelessd.getBlockHashesByTimestamp(1441911000, 1441914000, function(err, hashes) {
        should.exist(err);
    ...
    it('should get the correct block hashes', function(done) {
      ...
      helpthehomelessd.getBlockHashesByTimestamp(1441914000, 1441911000, function(err, hashes) {
        should.not.exist(err);
  ...
  describe('#getBlockHeader', function() {
    ...
    it('will give error from getBlockHash', function() {
      ...
      helpthehomelessd.getBlockHeader(10, function(err) {
        err.should.be.instanceof(Error);
      });
    });
    it('it will give rpc error from client getblockheader', function() {
      ...
      helpthehomelessd.getBlockHeader(blockhash, function(err) {
        err.should.be.instanceof(Error);
      });
    });
    it('it will give rpc error from client getblockhash', function() {
      ...
      helpthehomelessd.getBlockHeader(0, function(err) {
        err.should.be.instanceof(Error);
      });
    });
    it('will give result from client getblockheader (from height)', function() {
      ...
      helpthehomelessd.getBlockHeader(0, function(err, blockHeader) {
        should.not.exist(err);
    ...
    it('will give result from client getblockheader (from hash)', function() {
      ...
      helpthehomelessd.getBlockHeader(blockhash, function(err, blockHeader) {
        should.not.exist(err);
        getBlockHash.callCount.should.equal(0);
        blockHeader.should.deep.equal(result);
      });
  ...
  describe('#getBlockHeaders', function(){
      ...
      it('will gave error from getBlockHash', function(){
          ...
          helpthehomelessd.getBlockHeaders(10, function(err) {
              err.should.be.instanceof(Error);
          });
      });
      it('it will give rpc error from client getblockheaders', function() {
          ...
          helpthehomelessd.getBlockHeaders(blockhash, function(err){
              err.should.be.instanceof(Error);
          });
      });
      it("will get an array of block headers", function(){
          ...
          helpthehomelessd.getBlockHeaders(_blockHash, function(err, blockHeader){
              should.not.exist(err);
  ...
  describe('#_maybeGetBlockHash', function() {
    it('will not get block hash with an address', function(done) {
      ...
      helpthehomelessd._maybeGetBlockHash('8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi', function(err, hash) {
        if (err) {
          return done(err);
        }
        getBlockHash.callCount.should.equal(0);
    ...
    it('will not get block hash with non zero-nine numeric string', function(done) {
      ...
      helpthehomelessd._maybeGetBlockHash('109a', function(err, hash) {
        if (err) {
          return done(err);
        }
        getBlockHash.callCount.should.equal(0);
    ...
    it('will get the block hash if argument is a number', function(done) {
      ...
      helpthehomelessd._maybeGetBlockHash(10, function(err, hash) {
        if (err) {
          return done(err);
        }
  ...
  describe('#getBlockOverview', function() {
    ...
    it('will handle error from maybeGetBlockHash', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd._maybeGetBlockHash = sinon.stub().callsArgWith(1, new Error('test'));
      helpthehomelessd.getBlockOverview(blockhash, function(err) {
        err.should.be.instanceOf(Error);
        done();
      });
    });
    ...
    it('will give expected result', function(done) {
      ...
      helpthehomelessd.getBlockOverview(blockhash, function(err, blockOverview) {
        if (err) {
          return done(err);
        }
  ...
  describe('#estimateFee', function() {
    it('will give rpc error', function(done) {
      ...
      helpthehomelessd.estimateFee(1, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client estimateFee and give result', function(done) {
      ...
      helpthehomelessd.estimateFee(1, function(err, feesPerKb) {
        if (err) {
          return done(err);
        }
  ...
  describe('#sendTransaction', function(done) {
    var tx = hthcore.Transaction(txhex);
    it('will give rpc error', function() {
      ...
      helpthehomelessd.sendTransaction(txhex, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
      });
    });
    it('will send to client and get hash', function() {
      ...
      helpthehomelessd.sendTransaction(txhex, function(err, hash) {
        if (err) {
          return done(err);
        }
    ...
    it('will send to client with absurd fees and get hash', function() {
      ...
      helpthehomelessd.sendTransaction(txhex, {allowAbsurdFees: true}, function(err, hash) {
        if (err) {
          return done(err);
        }
        hash.should.equal(tx.hash);
    ...
    it('missing callback will throw error', function() {
      ...
      var transaction = hthcore.Transaction();
      (function() {
        helpthehomelessd.sendTransaction(transaction);
      }).should.throw(Error);
    });
  });
  ...
  describe('#getRawTransaction', function() {
    it('will give rpc error', function(done) {
      ...
      helpthehomelessd.getRawTransaction('txid', function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will try all nodes', function(done) {
      ...
      helpthehomelessd.getRawTransaction('txid', function(err, tx) {
        if (err) {
          return done(err);
        }
        should.exist(tx);
  ...
  describe('#getTransaction', function() {
    it('will give rpc error', function(done) {
      ...
      helpthehomelessd.getTransaction('txid', function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will try all nodes', function(done) {
      ...
      helpthehomelessd.getTransaction('txid', function(err, tx) {
        if (err) {
          return done(err);
        }
        should.exist(tx);
        tx.should.be.an.instanceof(hthcore.Transaction);
        done();
      });
    });
    it('will get from cache', function(done) {
  ...
  describe('#getDetailedTransaction', function() {
    ...
    it('should give a transaction with height and timestamp', function(done) {
      ...
      helpthehomelessd.getDetailedTransaction(txid, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('should give a transaction with all properties', function(done) {
      ...
      helpthehomelessd.getDetailedTransaction(txid, function(err, tx) {
        if (err) {
          return done(err);
        }
        checkTx(tx);
  ...
  describe('#getBestBlockHash', function() {
    it('will give rpc error', function(done) {
      ...
      helpthehomelessd.getBestBlockHash(function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client getInfo and give result', function(done) {
      ...
      helpthehomelessd.getBestBlockHash(function(err, hash) {
        if (err) {
          return done(err);
        }
        should.exist(hash);
  ...
  describe('#getBestChainLock', function () {
    it('will give rpc error', function (done) {
      ...
      helpthehomelessd.getBestChainLock(function (err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call getBestChainLock and give result', function (done) {
      ...
      helpthehomelessd.getBestChainLock(function (err, result) {
        if (err) {
          return done(err);
        }
        should.exist(result);
  ...
  describe('#getSpentInfo', function() {
    it('will give rpc error', function(done) {
      ...
      helpthehomelessd.getSpentInfo({}, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will empty object when not found', function(done) {
      ...
      helpthehomelessd.getSpentInfo({}, function(err, info) {
        should.not.exist(err);
  ...
  describe('#getInfo', function() {
    it('will give rpc error', function(done) {
      ...
      helpthehomelessd.getInfo(function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client getInfo and give result', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.node.getNetworkName = sinon.stub().returns('testnet');
  ...
  describe('#govObject', function() {
    it('will call client gobject list and give result', function(done) {
        ...
        helpthehomelessd.govObjectList({type: 1}, function(err, result) {
            if (err) {
                return done(err);
            }
            should.exist(result);
    ...
    it('will call client gobject get and give result', function(done) {
      ...
      helpthehomelessd.govObjectHash('4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00', function(err, result) {
        if (err) {
          return done(err);
        }
	...
	describe('#sporksList', function(){
		it('will call client sporks and give result', function(done){
			...
			helpthehomelessd.getSpork(function(err, SporkList) {
				if (err) {
					return done(err);
				}
  ...
  describe('#getMNList', function(){
    it('will call client masternode list and give result', function(done){
	    var helpthehomelessd = new DashService(baseConfig);
	    helpthehomelessd.isSynced = function(callback) { return callback(null, true) };
	    helpthehomelessd.nodes.push({
		    client: {
	    ...
	    helpthehomelessd.getMNList(function(err, MNList) {
		    if (err) {
			    return done(err);
		    }
    ...
    it('will return error if one of nodes not synced yet', function(done){
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.isSynced = function(callback) { return callback(null, false) };
      helpthehomelessd.nodes.push({
        client: {
          masternodelist: function(type, cb){
            switch (type){
    ...
    it('will return error if checking synced state of nodes failed', function(done){
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.isSynced = function(callback) { return callback(new Error('Failed')) };
      helpthehomelessd.nodes.push({
        client: {
          masternodelist: function(type, cb){
            switch (type){
  ...
  describe('#generateBlock', function() {
    it('will give rpc error', function(done) {
      ...
      helpthehomelessd.generateBlock(10, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client generate and give result', function(done) {
      ...
      helpthehomelessd.generateBlock(10, function(err, hashes) {
        if (err) {
          return done(err);
        }
  ...
  describe('#stop', function() {
    it('will callback if spawn is not set', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.stop(done);
    });
    it('will exit spawned process', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.spawn = {};
      helpthehomelessd.spawn.process = new EventEmitter();
      helpthehomelessd.spawn.process.kill = sinon.stub();
      helpthehomelessd.stop(done);
      helpthehomelessd.spawn.process.kill.callCount.should.equal(1);
      helpthehomelessd.spawn.process.kill.args[0][0].should.equal('SIGINT');
      helpthehomelessd.spawn.process.emit('exit', 0);
    });
    it('will give error with non-zero exit status code', function(done) {
      ...
      helpthehomelessd.spawn.process = new EventEmitter();
      helpthehomelessd.spawn.process.kill = sinon.stub();
      helpthehomelessd.stop(function(err) {
        err.should.be.instanceof(Error);
        err.code.should.equal(1);
        done();
      });
      helpthehomelessd.spawn.process.kill.callCount.should.equal(1);
      helpthehomelessd.spawn.process.kill.args[0][0].should.equal('SIGINT');
      helpthehomelessd.spawn.process.emit('exit', 1);
    });
    it('will stop after timeout', function(done) {
      var helpthehomelessd = new DashService(baseConfig);
      helpthehomelessd.shutdownTimeout = 300;
      helpthehomelessd.spawn = {};
      helpthehomelessd.spawn.process = new EventEmitter();
      helpthehomelessd.spawn.process.kill = sinon.stub();
      helpthehomelessd.stop(function(err) {
