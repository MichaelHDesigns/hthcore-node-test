...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    helpthehomelessd.spawn.datadir.should.equal(home + '/.dash');
    helpthehomelessd.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.dash/helpthehomelessd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.helpthehomelessd.spawn.datadir.should.equal('./data2');
  });
});
