...
var DashService = require('../../lib/services/helpthehomelessd');
...
describe('#start', function() {
  ...
  describe('will dynamically create a node from a configuration', function() {
    ...
    it('require each hthcore-node service with default config', function(done) {
      var node;
    ...
    it('require each hthcore-node service with explicit config', function(done) {
      var node;
      var TestNode = function(options) {
        options.services[0].should.deep.equal({
          name: 'helpthehomelessd',
