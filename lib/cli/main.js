...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make hthcore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `hthcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ hthcore-node add wallet-service');
      console.log('    $ hthcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ hthcore-node remove wallet-service');
      console.log('    $ hthcore-node remove insight-api');
      console.log();
    });
