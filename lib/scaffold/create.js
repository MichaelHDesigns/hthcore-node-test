...
/**
 * Will create a directory and helpthehomeless.conf file for HTH.
 ...
 * @param {String} options.datadir - The hth database directory
...
/**
 * Will setup a directory with a hthcore Node directory, configuration file,
 * helpthehomeless configuration, and will install all necessary dependencies.
 *
 * @param {Object} options
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The name of the hthcore node configuration directory
 * @param {String} options.datadir - The path to the hth datadir
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the hthcore-node directory and configuration
    ...
    function(next) {
      // Setup the HTH directory and configuration
